...
public class WheelPicker<T> extends View {
     ...
     * 是否显示幕布中间的线
     */
    private boolean mIsShowCenterLine;
	...
	private void initAttrs(Context context, @Nullable AttributeSet attrs) {
        ...
        mCenterLineColor = a.getColor(R.styleable.WheelPicker_wheelCurtainColor,
                Color.parseColor("#4dffffff"));
        mIsShowCurtainBorder = a.getBoolean(R.styleable.WheelPicker_wheelCurtainBorder, false);
        mIsShowCenterLine = a.getBoolean(R.styleable.WheelPicker_wheelCurtainBorder, true);
	...
	protected void onDraw(Canvas canvas) {
		...
		if(mIsShowCenterLine){
            ...
            float centerPosition =mSelectedItemRect.height()/2+mSelectedItemRect.top;
            canvas.drawLine(mSelectedItemRect.left,centerPosition,mSelectedItemRect.right,centerPosition,mPaint);
        }
