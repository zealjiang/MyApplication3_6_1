...
public class ScrollviewUITools {
        ...
        scrollView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            private final Runnable checkStopped = new Runnable() {
                ...
                public void run() {
                    ...
                    Log.d("mtest","scrollview right: "+scrollView.getChildAt(0).getRight()+" scrollX: "+x+" scrollWidth: "+scrollView.getMeasuredWidth()+" bottom: "+bottom);
